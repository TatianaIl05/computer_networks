...
\url{http://178.20.47.174/get_data} - просмотреть данные после парсинга
\url{http://178.20.47.174/get_data} - запустить парсинг
\url{http://178.20.47.174/clean_db?confirm=true} - удалить данные
